  ...
  _changeQuestion(ans) {
    ...
    if (j + 1 >= qustions.length) {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) =>
              AnswerScreen(maxScore: int.parse(widget.numOfQuestions), score: score, answers: answers, qustions: qustions, userAnswer: userAnswer),
        ),
      );
    } else {
      print("called");
              ...
              child: Column(
                ...
                children: [
                  CircularCountDownTimer(
                      ...
                      width: MediaQuery.of(context).size.width > 500 ? MediaQuery.of(context).size.width / 10 : MediaQuery.of(context).size.width / 6,
                      ...
                      textStyle: TextStyle(fontSize: 33.0, color: Color(0XFF1ea366), fontWeight: FontWeight.bold),
                  ...
                  Text(qustions[j].toString(),
                      style: TextStyle(
                          color: Color(0XFF1ea366), fontSize: MediaQuery.of(context).size.width > 500 ? 45 : 20, fontWeight: FontWeight.bold)),
                  SizedBox(height: 20),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
